...
#### APIKey와 pdf 저장 경로를 수정해 주세요.##

SERVER = "http://127.0.0.1:8000"
APIKey = 'd1129369caedf6877bb7f158a30af9301cbd0e8d27778ecea78916336c5c4f63' #여기 수정해 주세요
...
def pdf(data):
    ...
    with open('D:\\virous_sample\\test\\report_file.pdf', 'wb') as word :  ####여기 수정해 주세요###
        for chunk in r.iter_content(chunk_size = 8192):
            if chunk:
                word.write(chunk)
        return 'D:\\virous_sample\\test\\report_file.pdf'       ####여기 수정해 주세요###
